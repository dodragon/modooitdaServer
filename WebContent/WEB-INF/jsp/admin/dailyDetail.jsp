...
function update(){
	var seq = ${vo.seqNum};
	var todayJob = '${vo.todayJob}';
	var tomorrowJob = '${vo.tomorrowJob}';
	var successJob = '${vo.successJob}';
	var unSuccessJob = '${vo.unSuccessJob}';
	
	var form = document.createElement("form");
	form.setAttribute("charset", "UTF-8");
	form.setAttribute("method", "Post"); // Get 또는 Post 입력
	form.setAttribute("action", "./updateReport.api");
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div id="default-info">
              	<h3><fmt:formatDate value="${vo.reportDate }" pattern="yyyy-MM-dd HH:mm:ss"/></h3>
              	<h4>${vo.department } : ${vo.name } ${vo.jobClass }</h4>
              	<p>출근시간 : ${vo.attendTime }, 퇴근시간 : ${vo.closeTime }</p><br>
              	<h5>금일 업무</h5>
              	<p>${vo.todayJob }</p><br>
              	<h5>명일 업무</h5>
              	<p>${vo.tomorrowJob }</p><br>
              	<h5>완성 업무</h5>
              	<p>${vo.successJob }</p><br>
              	<h5>미완성 업무</h5>
              	<p>${vo.unSuccessJob }</p><br>
              </div>
            </div>
            </div>
