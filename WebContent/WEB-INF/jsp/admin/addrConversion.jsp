...
window.onload = function(){
	...
	var lonlat = '${lonlat}';
	if(lonlat){
		document.getElementById('longAndLat-output').innerHTML = lonlat;
	}
}
...
function geo(){
	...
	if(!addr){
		...
		form.setAttribute("action", "./adminGeo.api");
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      <a class="navbar-brand mr-1" href="./mainpage.api">경위도 조회</a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="#">경위도 조회</a>
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div id="default-info">
              	<h3>Address to Longitude and Latitude</h3>
              	<input id="addr-input" type="text" placeholder="변환할 주소를 입력해 주세요"><button onclick="geo()">확인</button><br>
              	<p id="longAndLat-output"></p>
              </div>
            </div>
            </div>
          </div>
