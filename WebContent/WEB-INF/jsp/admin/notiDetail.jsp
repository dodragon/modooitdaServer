...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3 id="notiTitle">${vo.title }</h3><button id="push-btn" onclick="send()">푸시 보내기</button></div>
            <div class="card-body">
              <p>${vo.content }</p>
              <br><br>
              <p>작성자 : ${vo.writer }</p>
              <p><fmt:formatDate value="${vo.noti_date }" pattern="yyyy년 MM월 dd일  HH:mm:ss"/></p>
            </div>
          </div>
        ...
        <form id="push-form" action="./notipush.api" method="post">
        	<input type="hidden" name="title" value="${vo.title }"/>
        	<input type="hidden" name="content" value="${vo.content }"/>
        	<input type="hidden" name="readers" value="${vo.read_div }"/>
        	<input type="hidden" name="seq_num" value="${vo.seq_num }"/>
        </form>
        <!-- /.container-fluid -->
