...
function update(){
	window.location.href = './mlUpdate.api?seq=' + ${vo.seqNum};
}
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div id="default-info">
              	<h3>${vo.meetingTitle }</h3>
              	<h4>${vo.mainAgenda }</h4>
              	<p>시작시간 : <fmt:formatDate value="${vo.startTime }" pattern="HH:mm"/> ~ 종료시간 : <fmt:formatDate value="${vo.endTime }" pattern="HH:mm"/></p><br>
              	<h5>회의 내용</h5>
              	<p>${vo.meetingContents }</p><br>
              	<h5>회의 결과</h5>
              	<p>${vo.meetingResult }</p><br>
              	<p>책임자 : ${vo.director }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;작성자 : ${vo.writer }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;장소 : ${vo.place }<br>
              	참여자 : ${vo.attendees } 총 ${vo.nop }명</p><br>
              	<p><fmt:formatDate value="${vo.meetingDate }" pattern="yyyy-MM-dd"/></p>
              </div>
            </div>
            </div>
