...
function deleteCp(){
	if(confirm('${vo.cpName}의 ${menu.menuName}을\n${vo.listDiv}에서\n정말 삭제 하시겠습니까?')){
		window.location.href = './mainListDelete.api?seq=${vo.seqNum}';
	}
}

function updateCp(){
	window.location.href = './mainListUpdate.api?cpSeq=${vo.cpSeq}';
}
</script>
<style type="text/css">
#listTitle{
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      <a class="navbar-brand mr-1" href="./mainpage.api">리스트 업체</a>
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <div>
              	<p style="display: inline-block">판매가 : </p>
              	<p style="display: inline-block; text-decoration:line-through;"><fmt:formatNumber value="${menu.price }" pattern="###,###원"/></p>
              	<p style="display: inline-block; font-size: 18px;"><fmt:formatNumber value="${menu.disPrice }" pattern="###,###원"/></p>
              	<p style="display: inline-block"> (${menu.percentAge }%)</p>
              </div>
              <p>선정일 : <fmt:formatDate value="${vo.selectDate }" pattern="yyyy년 MM월 dd일  HH:mm:ss"/></p>
            </div>
          </div>
        ...
        <div id="btn-div">
	        <button class="btn" onclick="deleteCp()">삭제하기</button>
	        <button class="btn" onclick="updateCp()">수정하기</button>
        </div>
        <!-- /.container-fluid -->
