...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      <a class="navbar-brand mr-1" href="./mainpage.api">이벤트 푸시 작성</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="http://192.168.0.11/baobab/jsp/admin/mainpage.api">
      ...
      <div id="content-wrapper">
      	<h2 style="margin-bottom: 17px;">푸시 작성</h2>
        <div class="container-fluid">
          <!-- DataTables Example -->
          <div class="card mb-3">
          	<form id="form" action="./adpushFirst.api" method="post">
	            <div class="card-header">
	            	<input name="title" id="title-input" type="text" placeholder="제목" maxlength="20"/>
		            <div class="card-body">
		                <textarea name="message" id="content" name="content" cols="120" rows="25" style="resize: none;" maxlength="300" placeholder="내용을 입력해 주세요.(300)"></textarea>
		            	<br>
        ...
        <div>
	        <button id="close-btn" onclick="back()">닫기</button>
