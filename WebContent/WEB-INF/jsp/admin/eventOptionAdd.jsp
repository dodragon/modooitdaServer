...
function save(){
	var data = JSON.stringify(getOption());
	
	var form = document.createElement("form");
	form.setAttribute("charset", "UTF-8");
	form.setAttribute("method", "Post"); // Get 또는 Post 입력
	form.setAttribute("action", "./optionaddSuccess.api");
...
function getOption(){
	var eventCpOptionVO = {
		optionName: document.getElementById('option-name-input').value,
		eventSerial: '${eventSerial}',
		menuList: getMenus('option0')
	};
	
	return eventCpOptionVO;
}

function checkData(){
	var options = document.getElementById('option-name-input');
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid" id="event-container">
          ...
          <div class="card mb-3" id="option0">
            <div class="card-header">
            	<input type="text" id="option-name-input" class="optionName" placeholder="옵션명 입력"/>
            </div>
            <div class="card-body">
        ...
        <button id="event-save" onclick="checkData()">중분류 전체 저장</button>
        <!-- /.container-fluid -->
