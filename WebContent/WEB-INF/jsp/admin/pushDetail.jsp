...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h3 id="notiTitle">${vo.title }</h3><button id="push-btn" onclick="send()">푸시 다시 보내기</button></div>
            <div class="card-body">
              <p>${vo.message }</p>
              <br><br>
              <p>작성자 : ${vo.writer }</p>
              <p><fmt:formatDate value="${vo.push_date }" pattern="yyyy년 MM월 dd일  HH:mm:ss"/></p>
            </div>
          </div>
        ...
        <form id="push-form" action="./adpush.api" method="post">
        	<input type="hidden" name="title" value="${vo.title }"/>
        	<input type="hidden" name="message" value="${vo.message }"/>
